...
booking.BookHour(client, patient.Id, new DateTime(2083, 10, 12, 11, 00, 00).ToUniversalTime());
booking.BookHour(client, patient.Id, dateTimeToCancel);
...
//modify booking time
booking.ModifyBookingTime(Client)
